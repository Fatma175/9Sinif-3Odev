...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1N5Nx7WEUcJpDRfzcGBhFAaQtXFBzLUW1d7sZ689H5r8/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **-1.26^2+1.84t+1.42E-03**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? **Cisim yavaşladığından dolayı a katsayısının negatif bir değer olduğunu düşünüyorum.**

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? **Hayır**

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) **a ve b**
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1WIp_wY6AC6wgw2X3Bue16Tb8uMZjQg2A07rHdwrBMdI/edit#gid=0) link veriniz.
...
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir? **Konum olarak 0.75 , zaman olarak 35 milisaniyelik(bence)**

2) Acaba hiç grafik çizmeden sürtünme katsayısını bulabilir miydim?  (Cevap: Evet). 
Yardım:
* Düzgün ivmelenen bir cisim için alınan yol formülü x = (ilk hız+ son hız)/2*t, burdan cismin ilk hızını bulunuz. **"0.675=(V1+0)/2"denkleminden V=1.35**
* Daha sonra iş-kinetik enerji teorimini kullanarak sürtünme kuvvetini bulun. Sürtünme kuvvetinden, kinetik sürtünme katsayısını bulunuz.**"1.35^211/2"den 0.91125 bulunur.0.91125=0.675*F ve buradan da yine 1.35 sonucu(bence)**
